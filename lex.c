...
/* fonction principale d'analayse lexicale */
     ...
     int analyse_lexicale(){
       /* allocation m�moire de temp de type la structure class */
       temp=(class *)malloc(sizeof(class));

       /* lecture du premier caract�re */

       Lire_Car();
       /* v�rification de mot par mot jusqu'� la fin du fichier */
       while(Car_Cour!=EOF){
           analyse();
           Lire_Car();
           //char c = getchar();
       ...
       temp->cls=EOF_TOKEN;
       temp->nom="EOF";
       /* ajouter le token de fin pour marquer la fin de v�rification */
       ajouter();
       /* afficher la liste chain�e et ecriture des r�sultats des tokens sur un fichier txt */
       afficherListe();
       /* initialisation du pointeur temp sur la tete de la lise chain�e */
      temp=head;
      int i=0;
       printf("=====================================================================\n");
       printf("     ===================FIN ANALYSE LEXICALE===================\n");
       /* chercher l'ERREUR sur la liste en parcourant la liste chain�e cr��e */
      while((strcmp(conversion(temp->cls),"ERREUR_TOKEN")!=0)&&(temp->next!=NULL))
      {
       temp=temp->next;
       i =i+1;
      }
      /* affichage de resultat de v�rification */
...
/* lecture des caract�res � partir du cfichier */
    char Lire_Car(){
...
/* ajout des resultats de test dans une liste chain�e */
    void ajouter(){
...
/* affichage de la liste chain�e et �criture sur le fichier r�sultat */
    void afficherListe(){
         printf("======================================================================\n");
...
/* conversion des valeurs du enum cr�� en chaine de caract�re */
